...
บทความนี้อธิบายเกี่ยวกับวิธีเข้าถึง API สำหรับ Customer Insights, สร้างการลงทะเบียนแอป Azure และเริ่มต้นใช้งานไลบรารีไคลเอนต์
...
1. หากต้องการเปิดใช้งาน API ในสภาพแวดล้อม Customer Insights ของคุณ ไปที่ **ผู้ดูแลระบบ** > **ความปลอดภัย** คุณต้องมีสิทธิ์ระดับผู้ดูแลระบบจึงจะทำได้

1. ไปที่แท็บ **API** และเลือกปุ่ม **เปิดใช้งาน**    
 
   การเปิดใช้งาน API จะสร้างคีย์การสมัครใช้งานหลักและรองสำหรับอินสแตนซ์ของคุณที่จะใช้ในคำขอ API คุณสามารถสร้างคีย์ใหม่ได้โดยเลือก **สร้างคีย์หลักใหม่** หรือ **สร้างคีย์รองใหม่** บน **ผู้ดูแลระบบ** > **ความปลอดภัย** > **API**
...
สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการลงทะเบียนแอปใน Azure โปรดดูที่ [ลงทะเบียนแอปพลิเคชัน](/graph/auth-register-app-v2)
...
[ส่วนการลงทะเบียนแอป](#create-a-new-app-registration-in-the-azure-portal) สรุปวิธีการลงทะเบียนแอปที่ต้องให้ผู้ใช้ลงชื่อเข้าใช้เพื่อการรับรองความถูกต้อง เรียนรู้วิธีสร้างการลงทะเบียนแอปที่ไม่ต้องการการโต้ตอบของผู้ใช้และสามารถเรียกใช้บนเซิร์ฟเวอร์ได้
...
1. สรุปได้ว่าเราต้องเพิ่มชื่อการลงทะเบียนแอปเป็นผู้ใช้ใน Customer Insights  
   ...
   เปิด Customer Insights ไปที่ **ผู้ดูแลระบบ** > **ความปลอดภัย** และเลือก **เพิ่มผู้ใช้**

1. ค้นหาชื่อการลงทะเบียนแอปของคุณ เลือกจากผลการค้นหาและเลือก **บันทึก**

## <a name="sample-queries"></a>การสอบถามตัวอย่าง

เราได้รวบรวมรายการสั้นๆ ของการสอบถามตัวอย่าง OData เพื่อทำงานกับ API: [ตัวอย่างการสอบถาม OData](odata-examples.md)
...
1. การตอบสนองน่าจะเป็นชนิด `object` เนื่องจากวิธีการดังกล่าวสามารถส่งคืนได้หลายชนิด (ตัวอย่างเช่น `IList<InstanceInfo>` และ `ApiErrorResult`) หากต้องการตรวจสอบชนิดการส่งคืน คุณต้องใช้ออบเจ็กต์ในชนิดการตอบสนองที่ระบุใน [หน้ารายละเอียด API](https://developer.ci.ai.dynamics.com/api-details#api=CustomerInsights) สำหรับการดำเนินการนั้น    
