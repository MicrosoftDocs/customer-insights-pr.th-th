...
หากคุณเพิ่มเอนทิตีในระดับแหล่งข้อมูลเพื่อในการช่วยปรับปรุงผลลัพธ์การรวมของคุณ ให้เลือกเอนทิตีเหล่านั้น สำหรับข้อมูลเพิ่มเติม โปรดดู [การเพิ่มแหล่งข้อมูล](data-sources-enrichment.md) หากคุณเลือกเอนทิตีที่เพิ่มความสมบูรณ์แล้วบนหน้า **เรกคอร์ดซ้ำ** คุณก็ไม่จำเป็นต้องเลือกอีก
...
> [!IMPORTANT]
> เอนทิตีแรกในรายการเรียกว่าเอนทิตีหลัก เอนทิตีหลักทำหน้าที่เป็นพื้นฐานสำหรับชุดข้อมูลโปรไฟล์แบบรวมของคุณ เอนทิตีเพิ่มเติมที่เลือกจะถูกเพิ่มในเอนทิตีนี้
>
...
1. บนหน้า **เงื่อนไขการจับคู่** ใช้ลูกศรเลื่อนขึ้นและลงเพื่อย้ายเอนทิตีตามลำดับที่คุณต้องการ หรือลากและวาง ตัวอย่างเช่น เลือก **Contacts:eCommerce** เป็นเอนทิตีหลักและ **CustomerLoyalty:Loyalty** เป็นเอนทิตีรอง
...
1. ในบานหน้าต่าง **เพิ่มกฎ** ให้กำหนดค่าเงื่อนไขสำหรับกฎ
   ...
   - **เลือกเอนทิตี/ฟิลด์ (แถวแรก)**: เลือกเอนทิตีที่เกี่ยวข้องและแอตทริบิวต์เพื่อระบุคุณสมบัติของเรกคอร์ดที่มีแนวโน้มว่าจะไม่ซ้ำกับลูกค้า ตัวอย่างเช่น หมายเลขโทรศัพท์หรือที่อยู่อีเมล หลีกเลี่ยงการจับคู่ตามแอตทริบิวต์ชนิดกิจกรรม ตัวอย่างเช่น รหัสการซื้อมีแนวโน้มที่จะไม่พบการจับคู่ในชนิดของเรกคอร์ดอื่นๆ
...
ในกรณีส่วนใหญ่ การจับคู่เอนทิตีจะนำไปสู่โปรไฟล์ลูกค้าที่ไม่ซ้ำกับข้อมูลที่รวมไว้ ในการแก้ไขกรณีที่ไม่ค่อยเกิดขึ้นบ่อยของผลลัพธ์ที่ผิดและผลลบผิด คุณกำหนดข้อยกเว้นสำหรับกฎการจับคู่ได้ ข้อยกเว้นจะนำไปใช้หลังจากประมวลผลกฎการจับคู่และหลีกเลี่ยงการจับคู่เรกคอร์ดทั้งหมด ซึ่งเป็นไปตามเกณฑ์ข้อยกเว้น
...
1. เลือก **ชนิดแบบกำหนดเอง** และเลือก **ดาวน์โหลดเทมเพลต** คุณต้องมีเทมเพลตแยกต่างหากสำหรับตัวเลือกการจับคู่แต่ละรายการ
