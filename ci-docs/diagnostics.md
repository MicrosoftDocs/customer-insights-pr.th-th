...
- ทรัพยากรที่ถูกต้องบน Azure ที่ตรงตาม [ข้อกำหนดของปลายทาง](/azure/azure-monitor/platform/diagnostic-settings#destination-requirements) สำหรับที่เก็บข้อมูล Azure, ฮับเหตุการณ์ Azure หรือ Azure Log Analytics
