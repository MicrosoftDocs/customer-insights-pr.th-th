...
1. เลือก **บันทึก** และ **เรียกใช้** เพื่อประมวลผลการเปลี่ยนแปลง 

## <a name="combine-fields-manually"></a>รวมฟิลด์ด้วยตนเอง

ระบุแอตทริบิวต์ที่ผสานด้วยตนเอง

1. บนเพจ **ผสาน** ให้เลือก **รวม**

1. เลือกตัวเลือก **ฟิลด์**
...
จัดการกลุ่มของฟิลด์เป็นหน่วยเดียว ตัวอย่างเช่น เมื่อเรกคอร์ดของเราประกอบด้วยฟิลด์ ที่อยู่1, ที่อยู่2, เมือง รัฐ และรหัสไปรษณีย์ เราอาจไม่ต้องการรวม ที่อยู่2 ของเรกคอร์ดอื่น โดยคิดว่าจะทำให้ข้อมูลของเราสมบูรณ์ยิ่งขึ้น

1. บนเพจ **ผสาน** ให้เลือก **รวม**

1. เลือกตัวเลือก **กลุ่มของฟิลด์**

1. ระบุนโยบายผู้ชนะการผสานในรายการแบบหล่นลง **จัดอันดับกลุ่มตาม**

1. เลือก **เพิ่ม** และเลือกว่าคุณต้องการเพิ่มฟิลด์หรือกลุ่มเพิ่มเติมลงในฟิลด์
