...
ผู้ดูแลระบบสามารถกำหนดค่า Customer Insights เพื่อ [ใช้สภาพแวดล้อม Dataverse ที่มีอยู่](create-environment.md) เมื่อพวกเขาสร้างสภาพแวดล้อม Customer Insights โดยการระบุ URL ไปที่สภาพแวดล้อม Dataverse ซึ่งจะแนบมากับสภาพแวดล้อมข้อมูลเชิงลึกของผู้ชมใหม่ของพวกเขา สภาพแวดล้อม Customer Insights และ Dataverse ต้องโฮสต์อยู่ในภูมิภาคเดียวกัน 
...
|AlternateValue    |String         |รหัสแทนที่แมปกับรหัสลูกค้า ตัวอย่าง: `cntid_1078`         |
