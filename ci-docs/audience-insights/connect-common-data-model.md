...
1. เลือก **เชื่อมต่อกับโฟลเดอร์ Common Data Model** ป้อน **ชื่อ** สำหรับแหล่งข้อมูล และเลือก **ถัดไป** ตั้งชื่อแนวทาง: 
   - ขึ้นต้นด้วยตัวอักษร
...
1. คุณจะได้รับรายชื่อของเอนทิตีที่มีอยู่ในไฟล์ model.json หรือ manifest.json ที่เลือก คุณสามารถรีวิวและเลือกจากรายการของเอนทิตีที่พร้อมใช้งาน และเลือก **บันทึก** เอนทิตีที่เลือกทั้งหมดจะมีการนำเข้าจากแหล่งข้อมูลใหม่
   > [!div class="mx-imgBorder"]
