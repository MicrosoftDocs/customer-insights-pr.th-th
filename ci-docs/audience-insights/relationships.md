...
องค์กรสร้างลำดับชั้นของบัญชีเพื่อจัดการบัญชีและความสัมพันธ์ซึ่งกันและกันได้ดียิ่งขึ้น ความสามารถด้านข้อมูลเชิงลึกของผู้ชมรองรับลำดับชั้นของบัญชีหลักและรองที่มีอยู่แล้วในข้อมูลลูกค้าที่นำเข้า ตัวอย่างเช่น บัญชีจาก Dynamics 365 Sales ลำดับชั้นเหล่านี้สามารถกำหนดค่าได้บนหน้า **ความสัมพันธ์** ในข้อมูลเชิงลึกของผู้ชม ใต้แท็บลำดับชั้นบัญชี
