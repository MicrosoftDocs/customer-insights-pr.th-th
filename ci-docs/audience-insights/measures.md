...
1. เลือก **แก้ไขชื่อ** และระบุ **ชื่อ** สำหรับการวัด 
   > [!NOTE]
   > หากการตั้งค่าคอนฟิกการวัดใหม่ของคุณมีเพียงสองฟิลด์ เช่น CustomerID และการคำนวณหนึ่งรายการ ผลลัพธ์จะถูกเพิ่มเป็นคอลัมน์ใหม่ในเอนทิตีที่ระบบสร้างขึ้นที่เรียกว่า Customer_Measure และคุณจะสามารถเห็นค่าของการวัดในโปรไฟล์ลูกค้าแบบรวม การวัดอื่นๆ จะสร้างเอนทิตีของตนเอง
