...
1. หากมีค่าในข้อมูลของคุณที่คุณต้องแทนที่ด้วยจำนวนเต็ม ตัวอย่างเช่น แทนที่ *null* ด้วย *0* เลือก **กฎ** กำหนดค่ากฎและตรวจสอบให้แน่ใจว่าคุณได้เลือกเฉพาะตัวเลขทั้งหมดเป็นตัวทดแทน
...
1. หากมีหลายเส้นทางระหว่างเอนทิตีข้อมูลที่คุณแมปและเอนทิตี *ลูกค้า* คุณต้องเลือกหนึ่งรายการที่ระบุ [เส้นทางความสัมพันธ์ของเอนทิตี](relationships.md) ผลการวัดอาจแตกต่างกันไปขึ้นอยู่กับเส้นทางที่เลือก 
   1. เลือก **การกําหนดลักษณะข้อมูล** และเลือกเส้นทางเอนทิตีที่ควรใช้เพื่อระบุการวัดของคุณ หากมีเพียงเส้นทางเดียวไปยังเอนทิตี *ลูกค้า* ตัวควบคุมนี้จะไม่แสดง
...
1. ในส่วน **กำหนดช่วงเวลา** กำหนดกรอบเวลาของข้อมูลที่จะใช้ เลือกว่าคุณต้องการให้การวัดใหม่ครอบคลุมชุดข้อมูลทั้งหมดหรือไม่โดยการเลือก **ตลอดเวลา** หรือถ้าคุณต้องการให้การวัดเน้นไปที่ **ช่วงเวลาเฉพาะ**
