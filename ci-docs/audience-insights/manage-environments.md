...
1. เลือกสัญลักษณ์ **การตั้งค่า** ในส่วนหัวของแอป

1. เลือก **สภาพแวดล้อมใหม่**
...
2. อีกทางเลือกหนึ่ง คุณสามารถเลือก **การตั้งค่าขั้นสูง**:
   ...
   - หากต้องการใช้ [การคาดการณ์](predictions.md) ให้ป้อน URL ของอินสแตนซ์ Common Data Service ในฟิลด์ **ที่อยู่เซิฟเวอร์** ภายใต้ **ใช้การคาดคะเน**
...
- แหล่งข้อมูลที่นำมาใช้/ที่นำเข้า
...
1. ไปยัง **ผู้ดูแลระบบ** > **ระบบ** > **เกี่ยวกับ**

2. เลือก **แก้ไข**

3. คุณสามารถปรับปรุง **ชื่อที่แสดง** ของสภาพแวดล้อม แต่คุณไม่สามารถเปลี่ยน **ภูมิภาค** หรือ **ชนิด**
...
คุณสามารถรีเซ็ตสภาพแวดล้อมเป็นสถานะว่างได้หากคุณต้องการลบการกำหนดค่าทั้งหมดและลบข้อมูลที่นำเข้า

1.  ไปยัง **ผู้ดูแลระบบ** > **ระบบ** > **เกี่ยวกับ**

2.  เลือก **รีเซ็ต** 

3.  การยืนยันการลบ ให้ป้อนชื่อสภาพแวดล้อมและเลือก **รีเซ็ต**
