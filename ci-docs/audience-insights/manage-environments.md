...
6. คุณสามารถระบุ URL สภาพแวดล้อม Microsoft Dataverse ภายใต้ **กำหนดค่าการแบ่งปันข้อมูลด้วย Microsoft Dataverse และเปิดใช้งานความสามารถเพิ่มเติม** ความสามารถเหล่านี้รวมถึงการแบ่งปันข้อมูลกับโปรแกรมประยุกต์และโซลูชันที่อิงตาม Microsoft Dataverse การนำเข้าข้อมูลจากแหล่งข้อมูลภายในองค์กร หรือการใช้งาน [การคาดคะเน](predictions.md) เลือก **เปิดใช้งานการแชร์ข้อมูล** เพื่อแชร์ข้อมูลผลลัพธ์ Customer Insights กับ Microsoft Dataverse Managed Data lake
   ...
   เมื่อคุณเปิดใช้งานการแบ่งปันข้อมูลด้วย Microsoft Dataverse การรีเฟรชแหล่งข้อมูลของคุณและกระบวนการอื่น ๆ อย่างเต็มรูปแบบหนึ่งครั้งจะถูกทริกเกอร์ หากกระบวนการกำลังทำงานและอยู่ในคิว คุณจะไม่เห็นตัวเลือกในการเปิดใช้งานการแบ่งปันข้อมูลด้วย Microsoft Dataverse คุณสามารถรอให้กระบวนการเหล่านั้นเสร็จสมบูรณ์หรือยกเลิกเพื่อเปิดใช้งานการแบ่งปันข้อมูล 
