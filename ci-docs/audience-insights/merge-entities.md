...
1.  คุณสามารถเพิ่มฟิลด์เพิ่มเติมเพื่อรวมในกระบวนการผสานได้
...
CustomerId ในเอนทิตีลูกค้าขึ้นอยู่กับแฮชของค่าแรกของคีย์หลักของผู้ชนะที่ไม่ใช่ค่าว่าง คีย์เหล่านี้มาจากเอนทิตีที่ใช้ในระยะการจับคู่และการผสาน และได้รับอิทธิพลจากลำดับการจับคู่ ดังนั้น CustomerID ที่สร้างขึ้นจึงสามารถเปลี่ยนแปลงได้เมื่อค่าคีย์หลักเปลี่ยนแปลงในเอนทิตีหลักของลำดับการจับคู่ ดังนั้น ค่าคีย์หลักอาจไม่ได้แสดงถึงลูกค้ารายเดียวกันเสมอไป
