...
ms.locfileid: "7643455"
---
# <a name="transaction-churn-prediction-preview"></a>การคาดคะเนการเลิกทำธุรกรรม (พรีวิว)
...
> [!TIP]
> ลองใช้บทช่วยสอนสำหรับการคาดคะเนการเลิกทำธุรกรรมโดยใช้ข้อมูลตัวอย่าง: [คู่มือตัวอย่างการคาดคะเนการเลิกทำธุรกรรม (ตัวอย่าง)](sample-guide-predict-transactional-churn.md)
...
- (ไม่จำเป็น) ข้อมูลเกี่ยวกับลูกค้าของคุณ:
    - ข้อมูลนี้ควรจัดแนวไปยังแอตทริบิวต์แบบคงที่มากขึ้นเพื่อให้แน่ใจว่าแบบจำลองทำงานได้ดีที่สุด
...
1. แมปแอตทริบิวต์เชิงความหมายกับฟิลด์ที่จำเป็นในการเรียกใช้โมเดล หากไม่มีการเติมข้อมูลในฟิลด์ด้านล่าง ให้กำหนดค่าความสัมพันธ์จากเอนทิตีประวัติการซื้อของคุณกับเอนทิตี *ลูกค้า*
...
1. แมปแอตทริบิวต์เชิงความหมายกับฟิลด์ในข้อมูลลูกค้าของคุณเองตามที่ระบุ ข้อมูลในฟิลด์ที่ใช้ไม่ควรเปลี่ยนแปลงบ่อยเพื่อให้แน่ใจถึงประสิทธิภาพที่ดีที่สุดของแบบจำลอง ตัวอย่างเช่น การเลือกฟิลด์สำหรับ "การจัดประเภท" ที่เปลี่ยนแปลงทุกเดือนจะมีเฉพาะค่าสุดท้ายที่ใช้ในการคาดคะเน แม้ว่าในอดีตค่าเดียวกันอาจไม่มีผลกับลูกค้าเมื่อสร้างรูปแบบการคาดคะเน

1. เลือก **ถัดไป**

### <a name="provide-an-optional-list-of-benchmark-accounts-business-accounts-only"></a>ระบุรายการบัญชีเกณฑ์มาตรฐานเป็นตัวเลือก (บัญชีธุรกิจเท่านั้น)
...
1. สำหรับบัญชีธุรกิจ คุณจะพบกับหน้าข้อมูล **การวิเคราะห์คุณลักษณะที่มีอิทธิพล** ประกอบด้วยข้อมูลสี่ส่วน:
    ...
    - รายการที่เลือกในบานหน้าต่างด้านขวาจะกำหนดเนื้อหาในหน้านี้ เลือกรายการจาก **ลูกค้าอันดับต้นๆ** หรือ **ลูกค้าเกณฑ์มาตรฐาน** ทั้งสองรายการเรียงลำดับตามค่าของคะแนนการเลิกใช้งานที่ลดลง ไม่ว่าคะแนนจะเป็นคะแนนสำหรับลูกค้าเท่านั้น หรือคะแนนรวมสำหรับลูกค้าและระดับรอง เช่น ประเภทผลิตภัณฑ์
        ...
        - **ลูกค้าเกณฑ์มาตรฐาน**: รายชื่อลูกค้าสูงสุด 10 รายที่ได้รับเลือกขณะกำหนดค่าแบบจำลอง
