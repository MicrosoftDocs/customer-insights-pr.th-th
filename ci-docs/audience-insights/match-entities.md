...
1. ไปที่ **ข้อมูล** > **รวมกัน** > **การจับคู่** และเลือก **กำหนดลำดับ** เพื่อเริ่มเฟสการจับคู่
1. เลือก **ลำดับเอนทิตี** ตัวอย่างเช่น เลือก **eCommerce:eCommerceContacts** เป็นเอนทิตีหลักและ **LoyaltyScheme:loyCustomers** เป็นเอนทิตีรอง 
1. เพื่อให้ทุกเรกคอร์ดในเอนทิตีเป็นลูกค้าที่ไม่ซ้ำและตรงกับเอนทิตีต่อไปนี้ทั้งหมด ให้เลือก **รวมทั้งหมด**
1. เลือก **สำเร็จ** 

หลังจากระบุลำดับการจับคู่ คู่การจับคู่ที่กำหนดไว้จะแสดงในส่วน **รายละเอียดเรกคอร์ดที่ตรงกัน** ใน **ข้อมูล** > **รวม** > **จับคู่** เมตริกหลักจะเว้นว่างจนกว่ากระบวนการจับคู่จะเสร็จสิ้น
...
1. เลือก **เพิ่มกฎ** ภายใต้เอนทิตีในส่วน **รายละเอียดเรกคอร์ดที่ตรงกัน** เพื่อกำหนดกฎการจับคู่
...
1. ในบานหน้าต่าง **สร้างกฎ** ให้กำหนดค่าเงื่อนไขสำหรับกฎ
   ...
   - **ความแม่นยำ**: ตั้งค่าระดับความแม่นยำที่จะใช้สำหรับเงื่อนไขนี้ 
     - **พื้นฐาน**: เลือกจาก *ต่ำ*, *ปานกลาง*, *สูง* และ *แน่นอน* เลือก **ตรงกันทุกประการ** เพื่อจับคู่เรกคอร์ดที่ตรงกัน 100 เปอร์เซ็นต์เท่านั้น เลือกหนึ่งในระดับอื่นๆ เพื่อให้จับคู่เรกคอร์ดที่ไม่เหมือนกัน 100 เปอร์เซ็นต์
...
เรกคอร์ดที่ซ้ำซ้อนจะถูกใช้ในกระบวนการจับคู่ข้ามเอนทิตี การขจัดข้อมูลซ้ำซ้อนเกิดขึ้นในแต่ละเอนทิตีและสามารถกำหนดค่าสำหรับทุกเอนทิตีที่ใช้ในคู่การจับคู่
...
## <a name="include-enriched-entities-preview"></a>รวมเอนทิตีที่เพิ่มข้อมูล (พรีวิว)

หากคุณเพิ่มข้อมูลเอนทิตีในระดับแหล่งข้อมูล ให้เลือกเอนทิตีก่อนที่จะเรียกใช้กระบวนการจับคู่ เอนทิตีที่เพิ่มข้อมูลสามารถปรับปรุงผลลัพธ์การรวมของคุณได้ สำหรับข้อมูลเพิ่มเติม โปรดดู [การเพิ่มแหล่งข้อมูล](data-sources-enrichment.md) 

เอนทิตีที่เพิ่มข้อมูลประกอบด้วยฟิลด์แหล่งข้อมูลดั้งเดิมและฟิลด์ที่เพิ่มข้อมูล ดังนั้น หากคุณเลือกที่จะทำงานกับเอนทิตีที่เพิ่มข้อมูล การกำหนดค่าที่มีอยู่จะไม่ได้รับผลกระทบ อย่างไรก็ตาม คุณอาจต้องปรับปรุงกฎการจับคู่เพื่อใช้ฟิลด์ที่เพิ่มข้อมูลแทน

1. ไปที่ **ข้อมูล** > **รวม** > **จับคู่** และเลือก **ใช้เอนทิตีที่เพิ่มข้อมูล** ที่ด้านบนของเพจ

1. จากบานหน้าต่าง **ใช้เอนทิตีที่เพิ่มข้อมูล** เลือกเอนทิตีที่เพิ่มข้อมูลอย่างน้อยหนึ่งรายการ

1. เลือก **สำเร็จ** ทุกครั้งที่ใช้เอนทิตีต้นทาง (เช่น ลำดับการจับคู่หรือกฎ) เอนทิตีจะถูกเปลี่ยนเป็นเอนทิตีที่เพิ่มข้อมูลโดยอัตโนมัติ
