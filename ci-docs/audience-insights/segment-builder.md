...
ในขณะที่สร้างเซ็กเมนต์ คุณสามารถบันทึกแบบร่างได้ ในลำดับขั้นแบบร่าง เซ็กเมนต์จะถูกบันทึกเป็นเซ็กเมนต์ที่ไม่ใช้งาน เมื่อคุณทำการตั้งค่าคอนฟิกเซ็กเมนต์เสร็จสมบูรณ์แล้ว ให้รันเพื่อเปิดใช้งานเซ็กเมนต์ หรือคุณสามารถ ***เริ่มการใช้งาน** _ เซ็กเมนต์จากหน้า _ *ทุกเซ็กเมนต์**
...
1. หากคุณมีหลายเงื่อนไขในกฎ คุณสามารถเลือกตัวดำเนินการเชิงตรรกะที่เชื่อมต่อได้  
   ...
   - คุณสามารถสร้างกฎหลายข้อเพื่อสร้างชุดเรกคอร์ดลูกค้าที่แตกต่างกัน คุณสามารถรวมกลุ่มเพื่อรวมลูกค้าที่จำเป็นสำหรับกรณีธุรกิจของคุณ เพื่อสร้างกฎใหม่ เลือก **เพิ่มกฎ** โดยเฉพาะอย่างยิ่ง หากคุณไม่สามารถรวมเอนทิตีในกฎได้เนื่องจากเส้นทางความสัมพันธ์ที่ระบุ คุณต้องสร้างกฎใหม่เพื่อเลือกแอตทริบิวต์จากกฎนั้น
...
1. ตามค่าเริ่มต้น เซ็กเมนต์จะสร้างเอนทิตีผลลัพธ์ที่มีแอตทริบิวต์ทั้งหมดของโปรไฟล์ลูกค้าที่ตรงกับตัวกรองที่กำหนด หากเซ็กเมนต์อิงอยู่กับเอนทิตีอื่นที่ไม่ใช่เอนทิตี *ลูกค้า* คุณสามารถเพิ่มแอตทริบิวต์เพิ่มเติมจากเอนทิตีเหล่านี้ไปยังเอนทิตีผลลัพธ์ได้ เลือก **แอตทริบิวต์ของโครงการ** เพื่อเลือกแอตทริบิวต์ที่จะต่อท้ายเอนทิตีผลลัพธ์  
   ...
   > - สำหรับเซ็กเมนต์ตามบัญชีธุรกิจ รายละเอียดของผู้ติดต่อหนึ่งรายหรือมากกว่าของแต่ละบัญชีจะต้องถูกรวมอยู่ในเซ็กเมนต์ เพื่ออนุญาตให้เปิดใช้งานหรือส่งออกเซ็กเมนต์นั้นไปยังปลายทางที่ต้องการข้อมูลผู้ติดต่อ
