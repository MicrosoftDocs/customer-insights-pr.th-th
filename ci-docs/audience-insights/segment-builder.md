...
>    - ตรวจสอบให้แน่ใจว่าแหล่งข้อมูลการติดต่อคือเอนทิตี [ที่แม็ปทางความหมายกับ ContactProfile](semantic-mappings.md#define-a-contactprofile-semantic-entity-mapping)
...
ในขณะที่สร้างเซ็กเมนต์ คุณสามารถบันทึกแบบร่างได้ ในลำดับขั้นแบบร่าง เซ็กเมนต์จะถูกบันทึกเป็นเซ็กเมนต์ที่ไม่ใช้งาน เมื่อคุณทำการตั้งค่าคอนฟิกเซ็กเมนต์เสร็จสมบูรณ์แล้ว ให้รันเพื่อเปิดใช้งานเซ็กเมนต์ นอกจากนี้คุณยังสามารถ **เริ่มการใช้งาน** เซ็กเมนต์จากหน้า **ทุกเซ็กเมนต์** ได้ด้วย
...
1. ก่อนที่คุณจะบันทึกและเรียกใช้เซ็กเมนต์ ให้เลือก **แก้ไขรายละเอียด** ที่อยู่ถัดจากชื่อเซ็กเมนต์ ระบุชื่อสำหรับเซ็กเมนต์ของคุณ และปรับปรุง **ชื่อเอนทิตีผลลัพธ์** ที่แนะนำสำหรับเซ็กเมนต์ คุณยังสามารถเพิ่มคำอธิบายให้กับเซ็กเมนต์ได้อีกด้วย
