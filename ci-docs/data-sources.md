...
แหล่งข้อมูลสามารถรีเฟรชตามกำหนดการอัตโนมัติหรือรีเฟรชด้วยตนเองได้ตามต้องการ [แหล่งข้อมูลภายในองค์กร](connect-power-query.md#add-data-from-on-premises-data-sources) รีเฟรชตามกำหนดการของตนเองซึ่งตั้งค่าไว้ระหว่างการนำเข้าข้อมูล สำหรับคำแนะนำในการแก้ปัญหา โปรดดูที่ [แก้ไขปัญหาปัญหาการรีเฟรชข้อมูลแหล่งข้อมูล PPDF Power Query](connect-power-query.md#troubleshoot-ppdf-power-query-based-data-source-refresh-issues)
...
## <a name="corrupt-data-sources"></a>แหล่งข้อมูลเสียหาย
...
:::image type="content" source="media/corrupt-task-error.png" alt-text="รายละเอียดงานแสดงข้อผิดพลาดของข้อมูลที่เสียหาย":::

เรกคอร์ดที่เสียหายจะแสดงในเอนทิตีที่สร้างโดยระบบ

### <a name="fix-corrupt-data"></a>แก้ไขข้อมูลที่เสียหาย

1. หากต้องการดูข้อมูลที่เสียหาย ไปที่ **ข้อมูล** > **เอนทิตี** และค้นหาหน่วยงานที่เสียหายในส่วน **ระบบ** ตั้งชื่อ Schema ของเอนทิตีที่เสียหาย: 'DataSourceName_EntityName_corrupt'

1. เลือกเอนทิตีที่เสียหาย แล้วเลือกแท็บ **ข้อมูล**

1. ระบุฟิลด์ที่เสียหายในเรกคอร์ดและเหตุผล

   :::image type="content" source="media/corruption-reason.png" alt-text="สาเหตุการเสียหาย" lightbox="media/corruption-reason.png":::

   > [!NOTE]
   > **ข้อมูล** > **เอนทิตี** แสดงเฉพาะบางส่วนของเรกคอร์ดที่เสียหาย หากต้องการดูเรกคอร์ดที่เสียหายทั้งหมด ให้ส่งออกไฟล์ไปยังคอนเทนเนอร์ในบัญชีที่เก็บข้อมูลโดยใช้ [กระบวนการส่งออก Customer Insights](export-destinations.md) หากคุณใช้บัญชีที่เก็บข้อมูลของคุณเอง คุณสามารถดูโฟลเดอร์ Customer Insights ในบัญชีที่เก็บข้อมูลของคุณได้

1. แก้ไขข้อมูลที่เสียหาย ตัวอย่างเช่น สำหรับแหล่งข้อมูล Azure Data Lake [แก้ไขข้อมูลใน Data Lake Storage หรืออัปเดตชนิดข้อมูลในไฟล์ manifest/model.json](connect-common-data-model.md#common-reasons-for-ingestion-errors-or-corrupt-data) สำหรับแหล่งข้อมูล Power Query แก้ไขข้อมูลในไฟล์ต้นฉบับและ [แก้ไขชนิดข้อมูลในขั้นตอนการแปลง](connect-power-query.md#data-type-does-not-match-data) บนหน้า **Power Query - แก้ไขการสอบถาม**

หลังจากการรีเฟรชครั้งต่อไปของแหล่งข้อมูล เรกคอร์ดที่แก้ไขจะถูกนำเข้าไปยัง Customer Insights และส่งต่อไปยังกระบวนการดาวน์สตรีม
