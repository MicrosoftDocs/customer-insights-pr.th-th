...
- บน Azure Synapse workspace *บริการหลักสำหรับ Customer Insights* ซึ่งเป็น "Dynamics 365 AI for Customer Insights" ต้องได้รับการกำหนดบทบาท **ผู้ดูแลระบบ Synapse** **ผู้ใช้** ต้องการบทบาท **ผู้สนับสนุนของ Synapse** ที่ได้รับมอบหมายสำหรับพื้นที่ทำงานเป็นอย่างน้อย สำหรับข้อมูลเพิ่มเติม โปรดดู [วิธีตั้งค่าการควบคุมการเข้าถึงสำหรับพื้นที่ทำงาน Synapse ของคุณ](/azure/synapse-analytics/security/how-to-set-up-access-control)
