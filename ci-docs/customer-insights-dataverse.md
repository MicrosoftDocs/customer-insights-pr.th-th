...
สมมติว่าคุณได้รับที่เก็บฐานข้อมูล 15 GB และที่เก็บไฟล์ 20 GB ต่อโปรไฟล์ลูกค้า 100,000 ราย หากการสมัครใช้งานของคุณมีโปรไฟล์ลูกค้า 300,000 โปรไฟล์ ความจุรวมของคุณจะเป็นที่เก็บข้อมูลฐานข้อมูล 45 GB (3 x 15 GB) และที่เก็บไฟล์ 60 GB (3 x 20 GB) ในทำนองเดียวกัน หากคุณมีการสมัครใช้งาน B2B ด้วยบัญชี 30K ความจุรวมของคุณจะเป็นที่เก็บข้อมูลฐานข้อมูล 45 GB (3 x 15 GB) และที่เก็บไฟล์ 60 GB (3 x 20 GB)
...
ผู้ดูแลระบบสามารถกำหนดค่า Customer Insights ให้เชื่อมต่อกับสภาพแวดล้อม Dataverse ที่มีอยู่ การระบุ URL ไปยังสภาพแวดล้อม Dataverse โดยเชื่อมต่อกับสภาพแวดล้อม Customer Insights ใหม่ของพวกเขา หลังจากสร้างการเชื่อมต่อระหว่าง Customer Insights กับ Dataverse อย่าเปลี่ยนชื่อองค์กรสำหรับสภาพแวดล้อม Dataverse ชื่อองค์กรที่ใช้ใน Dataverse URL และชื่อที่เปลี่ยนจะทำลายการเชื่อมต่อกับ Customer Insights
