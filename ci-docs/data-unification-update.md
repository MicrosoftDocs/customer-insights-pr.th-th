...
1. หลังจากทำการเปลี่ยนแปลงแล้ว ให้เลือกตัวเลือกถัดไป:
   ...
   - [รวมโปรไฟล์ลูกค้า](#run-updates-to-the-unified-customer-profile) เพื่อเรียกใช้เงื่อนไขการจับคู่และปรับปรุงเอนทิตี unified customer profile โดยไม่ส่งผลกระทบต่อการขึ้นต่อกัน (เช่น การเพิ่มความสมบูรณ์ เซ็กเมนต์ หรือการวัด) กระบวนการที่ขึ้นต่อกันไม่ได้ทำงาน แต่จะถูกรีเฟรชตามที่ [กำหนดไว้ในกำหนดการรีเฟรช](schedule-refresh.md)
...
1. จากหน้า **ข้อมูล** > **รวม** หน้า ให้เลือก:
   ...
   - **รวมโปรไฟล์ลูกค้า**: เรียกใช้เงื่อนไขการจับคู่และปรับปรุงเอนทิตี unified customer profile โดยไม่ส่งผลกระทบต่อการขึ้นต่อกัน (เช่น การเพิ่มความสมบูรณ์ เซ็กเมนต์ หรือการวัด) กระบวนการที่ขึ้นต่อกันไม่ได้ทำงาน แต่จะถูกรีเฟรชตามที่ [กำหนดไว้ในกำหนดการรีเฟรช](schedule-refresh.md)
